...
test('renders a pokemon to list', assert => {
    ...
    const expected = '<tr><td class="start">Mew<img src="../assets/products/mew.png" alt="Mew image" class="poke-img"></td><td>2</td><td>$1000000.00</td><td class="row-total">$2000000.00</td></tr>';
